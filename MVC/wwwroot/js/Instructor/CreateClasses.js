...
function populateTypeDropdown(data) {
  // Get unique types from the class data
...
function loadClasses() {
  $.ajax({
    ...
    success: function (response) {
      ...
      populateTypeDropdown(classData); // Populate the type dropdown
  ...
  Swal.fire({
    ...
    html: `
              <form id="editClassForm">
                  ...
                  <div class="mb-3">
                      <input type="number" id="editDuration" class="form-control" value="${
                        classData.duration || ""
                      }" placeholder="Duration (minutes)" min="0" max="1440" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                      <input type="number" id="editFee" class="form-control" value="${
                        classData.fee
                      }" placeholder="Fee" step="0.01" required>
                  </div>
                  <div class="mb-3">
                      <input type="text" id="editRequiredEquipments" class="form-control" value="${
    ...
    preConfirm: () => {
      ...
      const availableCapacity = parseInt($("#editAvailableCapacity").val()); // Capture the new value
      ...
      const updatedClass = {
        ...
        availableCapacity: availableCapacity, // Use the new value from the form
        fee: parseFloat($("#editFee").val()),
        requiredEquipments: $("#editRequiredEquipments").val(),
