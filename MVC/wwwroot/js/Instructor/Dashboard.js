document.addEventListener("DOMContentLoaded", function () {
    ...
    $(document).ready(function () {
        ...
        function loadBookedClasses() {
            $.ajax({
                url: "http://localhost:8080/api/Class/GetBookedClassesByUser/8",
                type: "GET",
                    ...
                    html += `<div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="class-detail">
                                            <strong>Instructor ID:</strong> ${c.instructorId}
                                        </div>
                                        <div class="class-detail">
                                    ...
                                    <div class="card-footer bg-transparent">
                                        <button class="btn btn-danger w-100 cancel-btn" data-id="${c.classId}" ${c.status !== 'Active' ? 'disabled' : ''}>
...
`,
                    ...
                    html += `<div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="class-detail">
                                            <strong>Status:</strong> <span class="badge ${c.status === 'Active' ? 'bg-success' : 'bg-warning'}">${c.status}</span>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-transparent">
    ...
    $(document).ready(function () {
                    ...
                    <form id="profileForm" class="profile-form">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="d-flex align-items-center">
                                <img id="imagePreview" src="" alt="Preview" class="ms-2" style="width: 86px; height: auto; margin-right: 14px; display: none; object-fit: cover;">
        ...
        $("#height").kendoNumericTextBox({
            min: 50, max: 250, step: 1, format: "# cm"
        });

        $("#weight").kendoNumericTextBox({
            min: 20, max: 200, step: 1, format: "#.00 kg"
        });
        ...
        $(document).on("submit", "#profileForm", function (e) {
            ...
            $.ajax({
                url: "http://localhost:8080/api/User/UserUpdateProfile",
                type: "PUT",
                processData: false,
                contentType: false,
                data: formData,
