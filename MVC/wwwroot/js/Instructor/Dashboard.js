  ...
  const html = `
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${
              classData.maxCapacity - classData.availableCapacity
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">
                <span class="badge ${
                  classData.status === "Active" ? "bg-success" : "bg-warning"
                }">
                    ${classData.status}
                </span>
            </div>
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${
              classData.requiredEquipments || "None"
            }</div>
        </div>
    `;
          ...
          <div class="k-drawer-content">
            ...
            <form id="profileForm" class="profile-form">
              <div class="mb-2">
                ...
                <input id="instructorName" class="form-control" readonly/>
              ...
              <div class="mb-2">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <img id="imagePreview" src="" alt="Preview" class="ms-2"
                    style="width: 86px; height: auto; margin-right: 14px; display: none; object-fit: cover;">
    ...
    classes.forEach(function (c) {
      tableHtml += `
                <tr>
                    ...
                    <td>${c.maxCapacity - c.availableCapacity}/${
        c.maxCapacity
      }</td>
                    <td>
                        <button class="btn btn-sm btn-primary" onclick="showClassDetails(${
                          c.classId
                        })">Details</button>
                    </td>
                </tr>
